...
class BaseFileShareHandler(BaseHandler):
    ...
    def build_html(self, path, dirs, files):
        ...
        builder.append('.header{display: flex; justify-content: space-between; padding: 8px 0; font-size: xx-large;}')
        ...
        builder.append('.btn-download{display: block; height: 24px; margin-left: 4px;}')
